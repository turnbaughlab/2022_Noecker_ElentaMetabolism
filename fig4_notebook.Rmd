...
test1 <- manova(met_pca2$x[,1:8]~phenotype_data2[,`Host health`])
summary(test1)

test1 <- manova(met_pca2$x[,1:4]~phenotype_data2[,`Host health`])
summary(test1)

test2 <- manova(met_pca2$x[,1:4]~phenotype_data2[,HealthCat])
summary(test2)

test2 <- manova(met_pca2$x[,1:8]~phenotype_data2[,HealthCat])
summary(test2)

test2a <- manova(met_pca2$x[,1:4]~phenotype_data2[,HealthCat2])
summary(test2a)

test2a <- manova(met_pca2$x[,1:8]~phenotype_data2[,HealthCat2])
summary(test2a)

test2a <- manova(met_pca2$x[,1:8]~phenotype_data2[,HealthCat3])
summary(test2a)


test3 <- manova(met_pca2$x[,1:8]~phenotype_data2[, Country2])
summary(test3)

test4 <- manova(met_pca2$x[,1:4]~phenotype_data2[, Country2])
summary(test4)

test5 <- manova(met_pca2$x[,1:8]~phenotype_data2[, Country2]+phenotype_data2[, HealthCat])
summary(test5)

test5 <- manova(met_pca2$x[,1:8]~phenotype_data2[, Country2]+phenotype_data2[, HealthCat2])
summary(test5)

test5 <- manova(met_pca2$x[,1:4]~phenotype_data2[, Country2]+phenotype_data2[, HealthCat])
summary(test5)

test5 <- manova(met_pca2$x[,1:4]~phenotype_data2[, Country2]+phenotype_data2[, HealthCat2])
summary(test5)

test5 <- manova(met_pca2$x[,1:4]~phenotype_data2[, Country3]+phenotype_data2[, HealthCat2])
summary(test5)
test5 <- manova(met_pca2$x[,1:8]~phenotype_data2[, Country3])
summary(test5)


test6 <- manova(met_pca2$x[,1:8]~phenotype_data2[,IsolationSource2])
summary(test6)

test6 <- manova(met_pca2$x[,1:4]~phenotype_data2[,IsolationSource2])
summary(test6)

test6 <- manova(met_pca2$x[,1:4]~phenotype_data2[,IsolationSource2]+phenotype_data2[, Country2]+phenotype_data2[, HealthCat])
summary(test6)
